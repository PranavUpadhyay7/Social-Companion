  ...
  return (
    <div className="  ">
      ...
      <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row justify-between gap-10 md:gap-0 w-[50vw] md:w-[80vw] py-20 mx-auto text-center">
        <Link href="/events">
          <button className="text-[#2e2e2e] font-black text-sm sm:text-sm lg:text-sm py-4 px-14 lg:px-20 tracking-widest rounded-2xl bg-white   hover:shadow-[0_0_6px_#66ff66,0_0_10px_#66ff66] transition-shadow duration-200">
            Events
          </button>
        </Link>
        <Link href="/clubbers">
